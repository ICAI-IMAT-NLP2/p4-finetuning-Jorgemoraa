...
class LoRA(nn.Module):
    def __init__(self, original_layer, r=4, alpha=32):
        ...
        self.A = nn.Parameter(torch.empty(original_layer.out_features, r))
        self.B = nn.Parameter(torch.empty(r, original_layer.in_features))
...
class SoftPromptEmbedding(nn.Module):
    ...
    def forward(self, input_embeddings):
        ...
        soft_prompt_expanded = self.soft_prompt.expand(batch_size, -1, -1)
